...
catalogo = Catalogo(host='exebaldi.mysql.pythonanywhere-services.com', user='exebaldi', password='cac2023bagues*', database='exebaldi$miapp')
...
RUTA_DESTINO = '/home/exebaldi/mysite/static/imagenes'
